      ...
      <View style={{ flex: 1 }}>
        <ScrollView
          ...
          <RkCard>
            ...
            <Image rkCardImg={true} source={require('../../data/img/Image12.png')} />
            ...
            <View rkCardFooter={true}>
              <RkButton rkType='clear link'>
                <FontAwesome name="heart" style={likeStyle} />
                <RkText rkType='accent'>18 Likes</RkText>
              </RkButton>
              <RkButton rkType='clear link'>
                <FontAwesome name="comment-o" style={iconButton} />
                <RkText rkType='hint'>2 Comments</RkText>
              </RkButton>
              <RkButton rkType='clear link'>
                <FontAwesome name="send-o" style={iconButton} />
          ...
          <RkCard>
            <View rkCardHeader={true}>
              <View style={{ flexDirection: 'row' }}>
                <Image source={require('../../data/img/Image12.png')} style={styles.avatar} />
                <View style={{}}>
